    ...
    <div className="min-h-screen bg-admin-bg flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white mb-1">399bet Admin</h1>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-admin-border bg-admin-sidebar text-primary-500 focus:ring-primary-500"
                />
        ...
        <div className="text-center mt-6">
          <a href="/" target="_blank" className="text-sm text-admin-muted hover:text-primary-400 transition-colors">
            ← Back to website
          </a>
        </div>
      </motion.div>
